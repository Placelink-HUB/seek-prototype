...
COMMENT ON TABLE SEEK_FILE_ANALYSIS IS '파일_탐지';

COMMENT ON COLUMN SEEK_FILE_ANALYSIS.ANALYSIS_ID IS '작업_ID';

COMMENT ON COLUMN SEEK_FILE_ANALYSIS.FILE_ID IS '파일_ID';
