...
COMMENT ON TABLE SEEK_ANALYSIS_RESULT IS '분석';

COMMENT ON COLUMN SEEK_ANALYSIS_RESULT.ANALYSIS_RESULT_ID IS '분석_ID';

COMMENT ON COLUMN SEEK_ANALYSIS_RESULT.ANALYSIS_TYPE_CCD IS '분석_타입_공통코드';

COMMENT ON COLUMN SEEK_ANALYSIS_RESULT.ANALYSIS_STATUS_CCD IS '분석_상태_공통코드';

COMMENT ON COLUMN SEEK_ANALYSIS_RESULT.ANALYSIS_MODEL IS '분석_모델';

COMMENT ON COLUMN SEEK_ANALYSIS_RESULT.ANALYSIS_HASH IS '분석_해시';

COMMENT ON COLUMN SEEK_ANALYSIS_RESULT.ANALYSIS_START_DT IS '분석_시작_일시';

COMMENT ON COLUMN SEEK_ANALYSIS_RESULT.ANALYSIS_END_DT IS '분석_종료_일시';

COMMENT ON COLUMN SEEK_ANALYSIS_RESULT.ANALYSIS_TIME IS '분석_시간(ms)';

COMMENT ON COLUMN SEEK_ANALYSIS_RESULT.TOTAL_DETECTED_COUNT IS '전체_검출_개수';
...
(
  ...
  CREATE_DT         TIMESTAMP  NOT NULL,
  PRIMARY KEY (ANALYSIS_RESULT_ID, ANALYSIS_ERROR_SN)
);

COMMENT ON TABLE SEEK_ANALYSIS_ERROR IS '분석_오류';

COMMENT ON COLUMN SEEK_ANALYSIS_ERROR.ANALYSIS_RESULT_ID IS '분석_ID';
...
COMMENT ON COLUMN SEEK_ANALYSIS_RESULT_ITEMS.ANALYSIS_RESULT_ID IS '분석_ID';
...
COMMENT ON TABLE SEEK_DATABASE_ANALYSIS IS '데이터베이스_작업';

COMMENT ON COLUMN SEEK_DATABASE_ANALYSIS.ANALYSIS_ID IS '작업_이력_ID';
...
COMMENT ON TABLE SEEK_ANALYSIS IS '작업_이력';

COMMENT ON COLUMN SEEK_ANALYSIS.ANALYSIS_ID IS '작업_이력_ID';

COMMENT ON COLUMN SEEK_ANALYSIS.ANALYSIS_TYPE_CCD IS '작업_타입_공통코드';
...
COMMENT ON TABLE SEEK_PROXY_ANALYSIS IS '프록시_작업';

COMMENT ON COLUMN SEEK_PROXY_ANALYSIS.ANALYSIS_ID IS '작업_이력_ID';

COMMENT ON COLUMN SEEK_PROXY_ANALYSIS.REQUEST_ID IS '작업_ID';
...
ALTER TABLE SEEK_ANALYSIS_RESULT_ITEMS
  ADD CONSTRAINT FK_SEEK_ANALYSIS_RESULT_TO_SEEK_ANALYSIS_RESULT_ITEMS
...
ALTER TABLE SEEK_ANALYSIS_ERROR
  ADD CONSTRAINT FK_SEEK_ANALYSIS_RESULT_TO_SEEK_ANALYSIS_ERROR
    FOREIGN KEY (ANALYSIS_RESULT_ID)
    REFERENCES SEEK_ANALYSIS_RESULT (ANALYSIS_RESULT_ID);
...
CREATE INDEX IX_SEEK_ANALYSIS_RESULT_HASH
  ON SEEK_ANALYSIS_RESULT (ANALYSIS_HASH ASC);
