...
CREATE TABLE SEEK_EMAIL_OUTBOUND_HIST
(
...
COMMENT ON TABLE SEEK_EMAIL_OUTBOUND_HIST IS '메일_외부전송_이력';

COMMENT ON COLUMN SEEK_EMAIL_OUTBOUND_HIST.OUTBOUND_ID IS '외부전송_ID';

COMMENT ON COLUMN SEEK_EMAIL_OUTBOUND_HIST.OUTBOUND_STATUS_CCD IS '외부전송_상태_공통코드';

COMMENT ON COLUMN SEEK_EMAIL_OUTBOUND_HIST.SENDER_EMAIL IS '발신자_이메일';

COMMENT ON COLUMN SEEK_EMAIL_OUTBOUND_HIST.ANALYSIS_ID IS '분석_ID';

COMMENT ON COLUMN SEEK_EMAIL_OUTBOUND_HIST.CREATE_DT IS '생성_일시';
