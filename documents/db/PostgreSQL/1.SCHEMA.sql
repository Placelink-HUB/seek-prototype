...
COMMENT ON COLUMN SEEK_ANALYSIS.TARGET_INFORMATION IS '대상_정보';

COMMENT ON COLUMN SEEK_ANALYSIS.ANALYSIS_CONTENT IS '분석_내용';
...
(
  SENSITIVE_INFORMATION_ID VARCHAR(256) NOT NULL,
...
COMMENT ON COLUMN TB_FILE.CREATE_DT IS '생성_일자';
...
COMMENT ON COLUMN TB_FILE_DETAIL.CONTENT_TYPE IS '콘텐츠_유형';
...
COMMENT ON COLUMN TB_FILE_DETAIL.CREATE_DT IS '생성_일자';
