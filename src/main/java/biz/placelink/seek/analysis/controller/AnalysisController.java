...
public class AnalysisController {
    ...
    public void tissue(HttpServletRequest request, HttpServletResponse response,
                       @RequestParam(required = false) Map<String, String> formDataParams,
                       @RequestBody(required = false) Map<String, Object> jsonParams) throws IOException {
        ...
        if (contentType != null && contentType.contains("application/json")) {
            ...
            if(jsonParams != null){
                ...
                Map<String, Object> map = objectMapper.readValue(json.toString(), Map.class);
